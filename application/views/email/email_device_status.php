                                        ...
                                        <tr>
                                            <td class="py-5">
                                                        ...
                                                        <tr>
                                                            <td class="text-center pb-4 pt-3">
                                                                <a href="<?php echo base_url(); ?>">
                                                                    <img class="email-logo" src="<?php echo get_logo($general_settings); ?>" alt="logo" /></a>
                                                                <h2 class="email-heading pt-4">
                                                                    IoTProject Tecnoparque
                                                                </h2>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                ...
                                                <table class="email-body text-center">
                                                    <tbody>
                                                        <tr>
                                                            <td class="px-3 px-sm-5 pt-3 pt-sm-5">
                                                                <?php if (str_contains($msg, 'Desconectado')) : ?>
                                                                    <img class="w-100px" src="<?php echo base_url(); ?>/assets/images/email/kyc-pending.png" alt="event">
                                                                <?php else : ?>
                                                                    <img class="w-100px" src="<?php echo base_url(); ?>/assets/images/email/kyc-success.png" alt="event">
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="px-3 px-sm-5 pb-2">
                                                                <?php if (str_contains($msg, 'Desconectado')) : ?>
                                                                    <h5 class="text-warning mb-3"><?php echo $msg ?></h5>
                                                                <?php else : ?>
                                                                    <h5 class="text-success mb-3"><?php echo $msg ?></h5>
                                                                <?php endif; ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="px-3 px-sm-5 pt-4 pb-4 pb-sm-5">
                                                                <p class="email-note">
                                                                    Este es un correo electrónico generado automáticamente <br> Por favor no responder a este email. Si usted enfrenta cualquier problema, por favor contáctenos en <br> <a href="mailto:help@iothost.org">help@iothost.org</a>
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
