                                        ...
                                        <div class="nk-content-body">
                                            <div class="nk-block-head nk-block-head-sm">
                                                <div class="nk-block-between">
                                                    <div class="nk-block-head-content">
                                                        <h3 class="nk-block-title page-title">Inventario de productos y consumibles</h3>
                                                                ...
                                                                <ul class="nk-block-tools g-3">
                                                                    <li>
                                                                        <div class="form-control-wrap">
                                                                            ...
                                                                            <input type="text" class="form-control" id="default-04" placeholder="Buscar un producto">
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="drodown">
                                                                            <a href="#" class="dropdown-toggle dropdown-indicator btn btn-outline-light btn-white" data-toggle="dropdown">Estado</a>
                                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="#"><span>Nuevos Productos</span></a></li>
                                                                                    <li><a href="#"><span>Disponibles</span></a></li>
                                                                                    <li><a href="#"><span>No disponibles</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                        ...
                                                        <div class="card-inner p-0">
                                                            <div class="nk-tb-list">
                                                                <div class="nk-tb-item nk-tb-head">
                                                                    ...
                                                                    <div class="nk-tb-col"><span>Codigo de Barras</span></div>
                                                                    <div class="nk-tb-col"><span>Precio</span></div>
                                                                    <div class="nk-tb-col"><span>Stock</span></div>
                                                                    <div class="nk-tb-col tb-col-md"><span>Categoria</span></div>
                                                                                ...
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                                        <ul class="link-list-opt no-bdr">
                                                                                            ...
                                                                                            <li><a href="#"><em class="icon ni ni-edit"></em><span>Editar Producto</span></a></li>
                                                                                            <li><a href="#"><em class="icon ni ni-eye"></em><span>Ver Product</span></a></li>
                                                                                            <li><a href="#"><em class="icon ni ni-activity-round"></em><span>Ventas producto</span></a></li>
                                                                                            <li><a href="#"><em class="icon ni ni-trash"></em><span>Eliminar Producto</span></a></li>
                                            ...
                                            <div class="nk-add-product toggle-slide toggle-slide-right" data-content="addProduct" data-toggle-screen="any" data-toggle-overlay="true" data-toggle-body="true" data-simplebar>
                                                <div class="nk-block-head">
                                                    <div class="nk-block-head-content">
                                                        <h5 class="nk-block-title">Nuevo Producto</h5>
                                                        <div class="nk-block-des">
                                                            <p>Agregue la información del nuevo producto.</p>
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-block-head -->
                                                <div class="nk-block">
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="product-title">Nombre del producto</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="regular-price">Precio de venta</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="sale-price">Precio de compra</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="SKU">Codigo de Barras</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label class="form-label" for="category">Categoia</label>
                                                                <div class="form-control-wrap">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="upload-zone small bg-lighter my-2">
                                                                <div class="dz-message">
                                                                    <span class="dz-message-text">Cargar imagen del producto</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <button class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Agregar</span></button>
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-block -->
                                            </div>
